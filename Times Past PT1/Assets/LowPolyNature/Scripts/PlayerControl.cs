...
public class PlayerControl : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        box_size = GetComponent<BoxCollider>();
    ...
    void Update()
    {
        ...
        var v = Input.GetAxis("Vertical") * r_speed;
        var h = Input.GetAxis("Horizontal") * r_speed;
        var rotation = Input.GetAxis("Horizontal") * rotSpeed;
        ...
        if (!IsDead && mIsControlEnabled)
        {
            ...
            _playerControl.Move(_moveDirection * Time.deltaTime);
        }
        */
